...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xd8mhoe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xd8mhoe.containers.anotherwebservice.com/
...
```
git clone git@github.com:divyahury/container-xd8mhoe.git
cd container-xd8mhoe
```
...
```
docker attach container-xd8mhoe
```
